...
namespace Exercice05SalarieHeritage.Classes
{
    internal static class IHM
    {
        ...
        public static void Start()
        {
            ...
            // Start(); //permet de faire de la récursivité => Start s'apelle elle même => on boucle
        }
            ...
            do
            {
                ...
                switch (choix)
                {
                    case "1":
                        ...
                        Salarie salarie = new Salarie(tuple.Matricule, tuple.Nom, tuple.Service, tuple.Categorie, tuple.Salaire);
                    ...
                    case "2":
                        ...
                        Comercial comercial = new Comercial(tupleSalarie.Matricule, tupleSalarie.Nom, tupleSalarie.Service, tupleSalarie.Categorie, tupleSalarie.Salaire, tupleCommercial.ChiffreDAffaire, tupleCommercial.Commission);
        ...
        private static (string Matricule, string Nom, string Service, string Categorie, decimal Salaire) SaisieChampsSalarie()
        {
            ...
            return (nom, matricule, categorie, service, salaire);
        }

        public static (decimal ChiffreDAffaire, decimal Commission) SaisieChampsCommercial()
        {
            Console.Write("Merci de saisir le chiffre d'affaire du commercial :");
            decimal chiffreDAffaire = decimal.Parse(Console.ReadLine());
        ...
        private static void RechercherSalarie()
        {
            ...
            {
                Console.WriteLine("Aucun salarie trouvé !");
            }
            else
            {
